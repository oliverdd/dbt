...
costs as (
    ...
    select
        ...
        case when asin = 'B07VQBB9FY' then 37.46
            when asin = 'B07QZD95LK' then 32.04
            when asin = 'B07QJDLPZF' then 28.92
            when asin = 'B07QZ4DK26' then 27.36
            when asin = 'B07QY9WNV1' then 27.36
            when asin = 'B07QY9C8YD' then 27.36
            when asin = 'B0751379Q9' then 15.36
            when asin = 'B076PMSD72' then 14.65
            when asin = 'B076PT9MT8' then 14.65
            when asin = 'B07FF9TC1M' then 14.39
            when asin = 'B01M4R32QX' then 14.17
            when asin = 'B072N1T2RN' then 13.88
            when asin = 'B0786Q46VR' then 13.42
            when asin = 'B01M7XI35O' then 13.17
            when asin = 'B072N28S7B' then 12.89
            when asin = 'B07BYQGCXX' then 12.49
            when asin = 'B07KFQS6KF' then 12.38
            when asin = 'B076FCD2KM' then 12.3
            when asin = 'B07WL7C1ZM' then 12.3
            when asin = 'B07KFQVBT9' then 11.49
            when asin = 'B07J1YD6MY' then 10.68
            when asin = 'B07KFQ2463' then 10.65
            when asin = 'B07MFZTHSP' then 10.25
            when asin = 'B0786NDJXX' then 10.1
            when asin = 'B077J34GD4' then 9.8
            when asin = 'B077J7FGRF' then 9.49
            when asin = 'B07FFFBWFL' then 9.35
            when asin = 'B07R1Z1WHD' then 9.12
            when asin = 'B06VVJLSZR' then 8.82
            when asin = 'B0797ZSZDW' then 7.84
            when asin = 'B07FL1PW5W' then 7.66
            when asin = 'B072KFZ9TQ' then 7.37
            when asin = 'B075L5HD6H' then 7.33
            ...
            when asin = 'B079KKM9BK' then 6.2
            when asin = 'B07RXLQSDT' then 5.48
            when asin = 'B07G4MW7TH' then 4.94
            when asin = 'B07FRN1R39' then 4.16
            when asin = 'B07FN5G6QC' then 4.09
            when asin = 'B07H8R7DDM' then 4.09
            when asin = 'B07C1XXX78' then 4
          else 0 end as cogs,
